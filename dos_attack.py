...
'''
    Running the l2ping command with the parameters entered.
'''
...
def main():
    ...
    if (input("Do you agree? (y/n) > ") in ['y', 'Y']):
        ...
        '''
            Request the device to launch the attack.
        '''
        ...
        '''
            Request the number of threads that will be running the attack.
        '''
        try:
